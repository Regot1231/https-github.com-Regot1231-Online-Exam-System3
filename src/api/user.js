...
export const studentUpdateInfoService = ({ username, name, gender, mobilephone, jobnumber, academy, role, class_name}) => request.patch('/my/userinfo', { username, name, gender, mobilephone, jobnumber, academy, class_name}, { headers:{ 'X-User-Role': role }})
// 更新密码信息
