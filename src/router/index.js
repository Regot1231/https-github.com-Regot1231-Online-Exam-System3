  ...
  routes: [
    ...
    { path: '/student', 
      ...
      children: [
        ...
        { path:'/student/profile', name: "student-profile", component: () => import('@/views/user/UserProfile.vue')},
        { path:'/student/password', name: "student-password", component: () => import('@/views/user/UserPassword.vue')},
      ]
  },
    { 
      path: '/teacher', 
